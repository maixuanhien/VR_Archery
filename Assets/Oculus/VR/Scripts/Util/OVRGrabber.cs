...
public class OVRGrabber : MonoBehaviour {
    ...
    protected virtual void GrabBegin() {
        ...
        foreach (OVRGrabbable grabbable in m_grabCandidates.Keys) {
            ...
            if (grabbable.CompareTag(Constants.TAG_BOW)) {
                grabbable.transform.position = transform.position;
                grabbable.transform.rotation = transform.rotation;
                var boxCollider = grabbable.GetComponent<BoxCollider>();
                boxCollider.isTrigger = true;
                var bowController = grabbable.GetComponent<BowController>();
                bowController.ActiceStringBow();
            }
